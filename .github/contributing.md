...
- Submit an [issue ticket](/people-leadership-documentation/issues) for your issue if there is not one already.
...
The issue tracker is the preferred channel for [bug reports](#bugs) and [features requests](#features).
